...
[System.Serializable]
public class TrainingSetDodgeBall
{
    public double[] input;
...
public class Perceptron : MonoBehaviour
{
    ...
    List<TrainingSetDodgeBall> ts = new List<TrainingSetDodgeBall>();
    double[] weights = { 0, 0 };
    double bias = 0;
    double totalError = 0;

    //The perceptron will control the npc, itll be the brain
    ...
    public void SendInput(double i1, double i2, double o)
    {
        ...
        {
            npc.GetComponent<Animator>().SetTrigger("Jump");
        ...
        TrainingSetDodgeBall s = new TrainingSetDodgeBall();
